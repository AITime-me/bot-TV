...
BOOKING_METHOD_ANALYTICS_LOOP = "booking_method_analytics"
ACQUISITION_SOURCE_ANALYTICS_LOOP = "acquisition_source_analytics"
AMOCRM_CRM_OAUTH_LIFECYCLE_LOOP = "amocrm_crm_oauth_lifecycle"
CONTROL_PLANE_SNAPSHOT_LOOP = "control_plane_snapshot"
