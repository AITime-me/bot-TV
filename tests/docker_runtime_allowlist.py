...
EXPECTED_DOCKER_ALLOW_RULES: tuple[str, ...] = (
    ...
    "!alembic/versions/20260825_33_teya_reliability.py",
    "!alembic/versions/20260826_34_booking_method.py",
    ...
    "!alembic/versions/20260906_42_vk_msg_reply_ext.py",
    "!app/",
    "!app/__init__.py",
    "!app/channels/",
    ...
    "!app/channels/vk_client_outbound_provenance.py",
    "!app/channels/vk_client_external_takeover_config.py",
    "!app/config.py",
    "!app/core/",
    ...
    "!app/core/booking_method_types.py",
    "!app/core/booking_method_remote.py",
    "!app/core/booking_method_http.py",
    "!app/core/acquisition_source_types.py",
    "!app/core/acquisition_source_remote.py",
    "!app/core/acquisition_source_http.py",
    ...
    "!app/core/amocrm_analytics_fields.py",
    ...
    "!app/models/teya_request_feed_cursor.py",
    ...
    "!app/repositories/teya_request_feed_cursors.py",
    ...
    "!app/services/teya_request_reconciliation_worker.py",
    "!app/services/booking_method_analytics_worker.py",
    ...
    "!app/services/vk_client_message_reply.py",
